...
STATSTRINGS = ["HP", "Attack", "Defense", "Special Attack", "Special Defense", "Speed"]
...
class PBStuff
  ...
  # ##--------------------------------------SETUPMOVE--------------------------------------------------------------###
  SETUPMOVE = [
    :SWORDSDANCE, :DRAGONDANCE, :CALMMIND, :WORKUP, :NASTYPLOT, :VICTORYDANCE, :AMNESIA, :IRONDEFENSE, :COTTONGUARD,
    :TAILGLOW, :BELLYDRUM, :BULKUP, :COIL, :CURSE, :GROWTH, :HONECLAWS, :QUIVERDANCE, :SHELLSMASH, :SHIFTGEAR,
    :NORETREAT, :STUFFCHEEKS, :TAKEHEART, :ACIDARMOR, :GEOMANCY, :GEARUP
  ]
  ...
  # ##--------------------------------------SCREENMOVE-------------------------------------------------------------###
  SCREENMOVE = [:LIGHTSCREEN, :REFLECT, :AURORAVEIL, :ARENITEWALL]
  ...
  # ##--------------------------------------BURNMOVE---------------------------------------------------------------###
  BURNMOVE = [:WILLOWISP, :SACREDFIRE, :INFERNO, :BURNINGJEALOUSY]

  # ##--------------------------------------PARAMOVE---------------------------------------------------------------###
  PARAMOVE = [:THUNDERWAVE, :STUNSPORE, :GLARE, :NUZZLE, :ZAPCANNON]
  ...
  RATESHARERS = [
    ...
    :KINGSSHIELD, :SPIKYSHIELD, :BANEFULBUNKER, :OBSTRUCT
  ]
...
class PBFields
  ...
  MAXGARDENMOVES = [:PETALDANCE, :PETALBLIZZARD]
