class PokeBattle_Move
  ...
  def pbCalcDamage(attacker, opponent, hitnum: 0)
    ...
    finalmult *= 0.75 if opponent.ability == :SHADOWSHIELD && [:STARLIGHT, :NEWWORLD, :DARKCRYSTALCAVERN, :DARKNESS2, :DARKNESS3].include?(@battle.FE) && opponent.damagestate.typemod > 4
