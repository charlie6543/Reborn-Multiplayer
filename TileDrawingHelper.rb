class TileDrawingHelper
  ...
  def self.fromTileset(tileset)
    ...
    bmautotiles = []
    for i in 0...7
      bmautotiles.push(pbGetAutotile(tileset.autotile_names[i])) if tileset.autotile_names[i] != ''
    end
  ...
  def bltSmallAutotile(bitmap, x, y, cxTile, cyTile, id, frame)
    ...
    if autotile.height == 32
      ...
      for i in 0...4
        ...
        bitmap.stretch_blt(Rect.new(i % 2 * cxTile + x, i / 2 * cyTile + y, cxTile, cyTile), autotile, src)
      end
    end
  end
