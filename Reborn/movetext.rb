MOVEHASH = {
  ...
  :OCTAZOOKA => {
    ...
    :effect => 50,
    :target => :SingleNonUser,
    :desc => "The user attacks by spraying ink in the target's face. It might lower the target's accuracy."
  },
  ...
  :FREEZEDRY => {
    ...
    :effect => 10,
    :target => :SingleNonUser,
    :desc => "The user rapidly cools the target, which might leave the target frozen. It's SE on Water types."
  },
  ...
  :STOKEDSPARKSURFER => {
    ...
    :target => :SingleNonUser,
    :zmove => true,
    :desc => "The user, Alolan Raichu, attacks the target with full force and leaves it with paralysis."
  },
